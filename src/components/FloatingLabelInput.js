...
//   inputStyle,
//   containerStyle,
//   placeholder, // ← NEW: accept placeholder
//   placeholderTextColor = 'rgba(0,0,0,0.35)', // ← NEW: softer placeholder by default
//   ...rest
// }) {
//   const focused = useRef(false);
//   const [isFocused, setIsFocused] = useState(false); // ← NEW: state to control placeholder visibility
...
//   // NEW: Only show placeholder when focused AND empty (prevents overlap with floating label)
...
//           setIsFocused(true); // ← keep render state in sync
//           Animated.timing(anim, {
//             toValue: 1,
//             duration: 140,
//             useNativeDriver: false,
...
//           setIsFocused(false); // ← keep render state in sync
//           Animated.timing(anim, {
//             toValue: value ? 1 : 0,
//             duration: 140,
//             useNativeDriver: false,
...
//         placeholder={effectivePlaceholder} // ← use conditional placeholder
//         placeholderTextColor={placeholderTextColor} // ← softer color
//         style={[
//           styles.input,
...
//     color: '#6b7b8c',
//     fontWeight: '700',
//     // if you ever see visual overlap, uncomment the next line
//     // backgroundColor: '#e9eef3',
//   },
//   input: {
//     color: '#1b2140',
