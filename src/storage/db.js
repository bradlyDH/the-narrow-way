...
// // // // Legacy API: openDatabase is sync and uses tx.executeSql callbacks
// // // export function getDb() {
// // //   if (dbInstance) return dbInstance;

// // //   // open or create the DB file
// // //   dbInstance = SQLite.openDatabase('app.db');
...
// //   // Classic API — works in Expo SDK 54, Expo Go, Dev Client
// //   dbInstance = SQLite.openDatabase('app.db');
