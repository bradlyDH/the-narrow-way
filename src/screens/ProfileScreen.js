...
// // //   useEffect(() => {
// // //     const off = subscribeAdmin((flag) => setIsAdminLocal(!!flag));
// // //     return off;
// // //   }, []);
...
// // //     Alert.alert(
// // //       'Sign out?',
// // //       'You’ll be signed out. You can continue as a guest or sign back in.',
// // //       [
...
// // //               // Reset the navigation stack and go to Auth screen
// // //               navigation.reset({
// // //                 index: 0,
// // //                 routes: [{ name: 'Auth' }],
// // //               });
...
// // //           {/* optional tiny hint in dev */}
// // //           {__DEV__ && (
// // //             <Text style={{ color: '#9CA3AF', fontSize: 11, marginTop: -6 }}>
// // //               (long-press title to toggle Debug)
// // //             </Text>
// // //           )}
// // //         </TouchableOpacity>
...
// // // Admin gate
// // import { isAdminCached, setAdminCached } from '../utils/adminGate';
// // import SecretTapGate from '../utils/secretTapGate';

// // export default function ProfileScreen({ navigation }) {
// //   const [isAdmin, setIsAdmin] = useState(isAdminCached());

// //   useEffect(() => {
// //     // if you later persist admin flag, sync local state on focus/etc.
...
// //         {/* Header row with secret multi-tap on title */}
...
// //           {/* Example: only show Debug button if gate is enabled or dev */}
// //           {(__DEV__ || isAdmin) && (
...
// //           <Text style={styles.cardTitle}>Profile Content</Text>
// //           <Text style={styles.cardMeta}>
// //             (Replace this area with your current profile UI.)
// //           </Text>
// //         </View>
...
// // Small invisible hotspot: 5 taps within 2 seconds → Debug (admin/dev only)
...
//       // while testing you can un-comment this to see the target
//       // android_ripple={{ color: 'rgba(255,0,0,0.08)', borderless: true }}
//     >
//       <View />
//     </Pressable>
//   );
...
//   return (
//     <Screen showBack onBack={() => navigation.goBack()}>
//       {/* Invisible hotspot in the corner */}
//       <SecretTapHotspot
...
//           {__DEV__ && (
//             <Text style={{ color: '#9CA3AF', fontSize: 11, marginTop: -6 }}>
//               (long-press title to toggle Debug • 5 taps top-right opens Debug)
//             </Text>
//           )}
//         </TouchableOpacity>
...
//   // 🔒 Secret hotspot in the top-right
//   secretHotspot: {
//     position: 'absolute',
//     right: 0,
...
// Invisible hotspot: 5 taps within 2 seconds → Debug (admin/dev only)
function SecretTapHotspot({ onTrigger, enabled }) {
  const ref = useRef({ count: 0, timer: null });
  if (!enabled) return null;
    ...
    <Screen showBack onBack={() => navigation.goBack()}>
      ...
      >
        ...
        >
          ...
          {__DEV__ && (
            <Text style={{ color: '#9CA3AF', fontSize: 11, marginTop: -6 }}>
              (long-press title toggles Debug • 5 taps top-right opens Debug)
            </Text>
          )}
        </TouchableOpacity>
