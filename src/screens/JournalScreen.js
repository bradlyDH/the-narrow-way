...
// import { createJournalEntry, getJournalEntries } from '../logic/journal';
...
//   const virtue = getTodaysVirtue() || 'Today';
...
//     try {
//       setSaving(true);
//       const created = await createJournalEntry(note, virtue);
//       setNote('');
//       if (created) {
//         // reload or optimistically prepend
