...
//       r.id === req.id ? { ...r, last_prayed_at: todayISO() } : r
//     );
//     setRequests(updated);
...
//         .from('prayer_requests')
//         .update({ last_prayed_at: todayISO() })
//         .eq('id', req.id);
//       if (error) throw error;
//     } catch (e) {
...
//   // --- swipe actions
//   const RightActions = ({ progress, dragX, onAnswered, onDelete }) => {
//     return (
...
//   },
//   answeredBtn: { backgroundColor: '#1b8a5a' },
