...
// // // // // //   // NEW: jump straight to Encouragement composer for this friend (inside Home tab)
...
// // // // //       // Normalize lists to { friendship_id, person: {id, display_name, short_id} }
// // // // //       const inc = (incData || []).map((row) => ({
// // // // //         friendship_id: row.id,
// // // // //         person: row.requester, // incoming: requester is the other person
// // // // //       }));
...
// // // // //         .eq('addressee_id', userIdRef.current); // safety
// // // // //       if (error) throw error;
// // // // //       // realtime will also confirm and keep lists fresh
// // // // //     } catch (e) {
// // // // //       // rollback
// // // // //       setIncoming(prevIncoming);
// // // // //       setFriends(prevFriends);
...
// // // // //   // --- NEW: navigate to Encouragement on the ROOT stack (not the tabs) ---
// // // // //   const startEncouragement = (row) => {
// // // // //     const p = row.person;
// // // // //     const params = {
// // // // //       targetId: p.id,
...
// // // // //     // If we're inside tabs, use the parent (root) navigator.
// // // // //     const parent =
// // // // //       typeof navigation.getParent === 'function'
// // // // //         ? navigation.getParent()
// // // // //         : null;

// // // // //     (parent || navigation).navigate('Encouragement', params);
// // // // //   };
...
// // // //   // --- Jump to Encouragement composer (IMPORTANT: target parent navigator) ---
// // // //   const startEncouragement = (row) => {
// // // //     const p = row.person;
// // // //     const params = {
// // // //       targetId: p.id,
...
// // // //     // Prefer the parent (root stack). If absent, fall back to current.
// // // //     const parent = navigation.getParent?.();
// // // //     if (parent && typeof parent.navigate === 'function') {
// // // //       parent.navigate('Encouragement', params);
// // // //     } else {
// // // //       navigation.navigate('Encouragement', params);
// // // //     }
// // // //   };
...
// // //   // --- Cross-navigator navigation (logic-only change) ---
// // //   // When a screen is inside the Tab navigator but the target screen
// // //   // (Encouragement) is registered on the parent Stack, use getParent().navigate.
// // //   const startEncouragement = (row) => {
// // //     const p = row.person;
// // //     const params = {
// // //       targetId: p.id,
...
// // //       parent.navigate('Encouragement', params);
// // //     } else {
// // //       // safe fallback if tree changes later
// // //       navigation.navigate('Encouragement', params);
// // //     }
// // //   };
...
// //   // --- NEW: jump to root-stack Encouragement safely from inside tabs
// //   const startEncouragement = (row) => {
// //     const p = row.person;
// //     const params = {
// //       targetId: p.id,
...
// //     // If we're nested (inside Tab), ask the parent (root Stack) to navigate
// //     const parent = navigation.getParent?.();
// //     if (parent) {
// //       parent.navigate('Encouragement', params);
// //     } else {
// //       // fallback if this screen is ever mounted at root
// //       navigation.navigate('Encouragement', params);
// //     }
// //   };
...
// //                                   style: 'destructive',
// //                                   onPress: () => {
// //                                     // you already had a removeFriend flow earlier; keep it if needed
// //                                     Alert.alert(
// //                                       'Not implemented',
...
//   // NEW: jump straight to Encouragement composer for this friend
//   const startEncouragement = (row) => {
//     const p = row.person;
//     // IMPORTANT: target the PARENT (root stack) explicitly so it finds the route
//     const parent = navigation.getParent?.();
//     (parent || navigation).navigate('Encouragement', {
//       targetId: p.id,
//       targetName: p.display_name || 'Unnamed User',
//       targetShortId: p.short_id,
//     });
...
//         .delete()
//         .eq('id', row.friendship_id);
//       // either side can own the row per RLS; the id filter is enough
//       if (error) throw error;
//     } catch (e) {
//       setFriends(prevFriends); // rollback
//       Alert.alert('Error', e?.message || 'Could not remove friend.');
