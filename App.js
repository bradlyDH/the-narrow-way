...
// ✅ Deep link config (handles both app scheme & Expo dev URL)
const linking = {
  prefixes: [Linking.createURL('/')], // e.g., narrowway:// and exp:// in dev
  config: {
    screens: {
      Auth: 'auth', // narrowway://auth → Auth screen
      MainTabs: {
        screens: {
          Home: '', // optional — root maps to tabs
        },
      },
